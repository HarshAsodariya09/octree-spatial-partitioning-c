...
// Define constants
#define MAX_SIZE 100       // Maximum size of the octree
#define MAX_DEPTH 5        // Maximum depth of the octree
#define MAX_POINTS 2       // Maximum number of points in a node
#define STEP 5             // Step size for moving points
#define COLLISION_SIZE 10  // Size of the collision box around a moving point
